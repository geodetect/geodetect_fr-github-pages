...
jQuery(window).load(function() {
    ...
    $('.geodetect-waypoint').css('marginTop', $('.geodetect-header').outerHeight(true) );
}
});

// Fixed Header
// ======================
var $head = $( '#geodetect-header' );
jQuery( '.geodetect-waypoint' ).each( function(i) {
    var $el = $( this ),
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head.attr('class', 'geodetect-header ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head.attr('class', 'geodetect-header ' + animClassUp);
        }
    }, { offset: '-1px' } );
} );
...
var $head2 = $( '#geodetect-header2' );
jQuery( '.geodetect-waypoint2' ).each( function(i) {
    var $el = $( this ),
        animClassDown = $el.data( 'animateDown' ),
        animClassUp = $el.data( 'animateUp' );
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head2.attr('class', 'geodetect-header2 ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head2.attr('class', 'geodetect-header2 ' + animClassUp);
        }
